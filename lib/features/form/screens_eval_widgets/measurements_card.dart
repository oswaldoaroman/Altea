  ...
  Widget build(BuildContext context) {
    return AppCard(
      child: Column(
        ...
        children: [
          SliderWithInput(label: 'Peso', value: peso, min: 40, max: 150, suffix: 'kg', onChanged: onPesoChanged),
          const SizedBox(height: 10),
          SliderWithInput(label: 'Estatura', value: estatura, min: 130, max: 210, suffix: 'cm', onChanged: onEstaturaChanged),
        ],
      ),
    );
  }
