...
class UsageInstructions extends StatelessWidget {
  ...
  static const _pasos = [
    (
      ...
      'Haz tu evaluación',
      'Responde unas preguntas rápidas sobre tu estilo de vida.',
    ),
    (
      Icons.insights_rounded,
      'Revisa tu riesgo',
      'Altea te muestra tu resultado y qué factores lo afectan.',
    ),
    (
      Icons.forum_rounded,
      'Actúa y da seguimiento',
      'Sigue las recomendaciones, habla con Altea o agenda con tu médico.',
    ),
  ];
