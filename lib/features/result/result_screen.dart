...
import 'package:altea/widgets_reutilizables/app_card.dart';
import '../../widgets_reutilizables/responsive_body.dart';
import '../../widgets_reutilizables/risk_gauge.dart';
      ...
      child: SingleChildScrollView(
        child: ResponsiveBody(
          child: Column(
            ...
            children: [
            const TopTitle(title: 'Tu evaluación', subtitle: 'Resultado actual'),
            Padding(
              ...
              child: Column(
                children: [
                  AppCard(
                    child: Column(
                      children: const [
                        ...
                        SizedBox(height: 10),
                        Text('Probabilidad estimada · años de riesgo clínico',
                  ...
                  Align(
                    ...
                    child: Text('Factores detectados',
                  ...
                  AppCard(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Recomendaciones inmediatas',
                            style: TextStyle(fontWeight: FontWeight.w800, fontSize: 12.5, color: AppColors.navy)),
                        const SizedBox(height: 10),
                        ...List.generate(_recs.length, (i) => Padding(
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: const Text('Preguntar a Altea', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 12.5)),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: PillButton(label: 'Contactar doctor', color: AppColors.navy, onPressed: () {  },),
                      ),
                    ],
                  ),
